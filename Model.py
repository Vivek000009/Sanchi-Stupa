...
architecture_info = {
    ...
    "anda": {
        ...
        "text":
            "The Anda forms the principal mass of the stupa.\n\n"
            "Its rounded mound recalls the early burial mound "
            "tradition and encloses the sacred core of the monument.\n\n"
            "It is one of the most recognisable elements of "
    ...
    "harmika": {
        ...
        "text":
            "The Harmika is the square enclosure positioned above "
            "the dome.\n\n"
            "It marks the upper sacred zone of the stupa and supports "
            "the central mast or Yasti."
    },
    ...
    "chattra": {
        ...
        "text":
            "The Chattras are umbrella-like discs placed above "
            "the Harmika.\n\n"
            "The umbrella was an ancient Indian symbol associated "
            "with honour, protection and spiritual importance."
    },
    ...
    "yasti": {
        ...
        "text":
            "The Yasti is the vertical mast rising from the top "
            "of the stupa.\n\n"
            "It supports the Chattra arrangement and emphasizes "
            "the monument's vertical axis."
    },
    ...
    "vedika": {
        ...
        "text":
            "The Vedika is the railing surrounding the stupa.\n\n"
            "It defines the sacred enclosure while guiding movement "
            "around the monument."
    },
    ...
    "torana": {
        ...
        "text":
            "The Toranas are monumental gateways placed around "
            "the stupa.\n\n"
            "At Sanchi they are famous for sculptural narratives "
            "and elaborate architectural decoration."
    },
    ...
    "pradakshina": {
        ...
        "text":
            "The Pradakshina Patha is the route used to walk "
            "clockwise around the sacred monument.\n\n"
            "Movement around the stupa forms an important part "
            "of ritual engagement with the structure."
    }
}
